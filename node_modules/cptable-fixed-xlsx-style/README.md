...
- Excel 5.0/95 (XLS BIFF5)10.143.19.5:30018/swagger-ui.html
...
With [npm](https://www.npmjs.org/package/cptable-fixed-xlsx-style):

```sh
npm install cptable-fixed-xlsx-style --save
```
...
```sh
bower install js-cptable-fixed-xlsx-style#beta
```
